...
class LocalSelfAttention(OurLayer):
    ...
    def __init__(self, heads, size_per_head, neighbors=1, rate=1, block_size=6, d_encoder=4,
                 key_size=None, mask_right=False, **kwargs):
    ...
    def build(self, input_shape):
        ...
        self.reshape = Reshape((int(self.block_size * self.block_size / 2), self.d_encoder * 3))
...
class LocalSelfAttention2(OurLayer):
    ...
    def __init__(self, heads, size_per_head, neighbors=1, rate=1, block_size=6, d_decoder=16,
                 key_size=None, mask_right=False, **kwargs):
    ...
    def build(self, input_shape):
        ...
        self.attention = MultiHeadAttention(
            ...
            value_dim=8,
            num_heads=1,
            name = "localMultiAttention2"
        )
        self.reshape = Reshape((int(self.block_size * self.block_size), self.d_decoder * 3), name = "localreshape1")
