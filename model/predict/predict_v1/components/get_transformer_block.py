...
from model.predict.predict_v1.components.get_local_attention import LocalSelfAttention, LocalSelfAttention2
@tf.keras.utils.register_keras_serializable()
class TransformerEncoderBlock(layers.Layer):
    """Implements a Transformer Encoder block."""

    def __init__(self, *args, num_heads, mlp_dim, dropout, block_size=6, d_encoder=4, **kwargs):
...
class TransformerDecoderBlock(layers.Layer):
    ...
    def __init__(self, *args, num_heads, mlp_dim, dropout, block_size=6, d_decoder=8, **kwargs):
        super().__init__(*args, **kwargs)
        self.dense = None
        self.dropout_layer = None
        self.layer_norm1 = None
    ...
    def build(self, input_shape):
        ...
        self.dense = Dense(units=8,name= "dense_decode_3")

    def call(self, inputs_arr):
        inputs = inputs_arr

        x = self.att2(inputs)  # 这个里面会突然的把batch_size * 2？为啥
