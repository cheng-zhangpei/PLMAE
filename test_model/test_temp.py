...
def ours_experiment_chessboard(bit, dir_path, pixel_cnt, block_size, model_name,masking_rate):
    ...
    for filename in os.listdir(dir_path):
        # for m in range(100):
            ...
            decoder_outputs, spatial_mask_infos, chessboard_blocks, origin_block = masking_block(blocks,
                                                                                       0.75)
            print(spatial_mask_infos[1])
            print(spatial_mask_infos[2])
            # print("放入模型的棋盘格")
            ...
            #
            # # save_path = "./predicted_image/"+str(filename)
